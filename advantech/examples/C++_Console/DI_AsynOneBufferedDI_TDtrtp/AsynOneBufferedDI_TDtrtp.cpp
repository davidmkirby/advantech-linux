...
*    Delay to Start and Delay to Stop function together.
*
* Instructions for Running:
*    1. Set the 'deviceDescription' for opening the device.
*	  2. Set the 'profilePath' to save the profile path of being initialized device. 
*    3. Set the 'portEnable' to decide which port to be used.
*    4. Set the 'enableCount' to decide how many ports to scan input samples.
