...
public class AsynchronousOneWaveformAO extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AsynchronousOneWaveformAO frame = new AsynchronousOneWaveformAO();
	...
	public AsynchronousOneWaveformAO() {
		...
		txtHighLevelA.setValue(new Integer(5));
		...
		txtLowLevelA.setValue(new Integer(-5));
		...
		txtHighLevelB.setValue(new Integer(5));
		...
		txtLowLevelB.setValue(new Integer(-5));
		...
		btnConfigure.setBounds(64, 395, 115, 23);
		...
		btnStart.setBounds(204, 395, 90, 23);
		...
		// Add the stopped event listener to the control.
	...
	protected void ConfigureDevice() {
		try {
			...
			bufferedAoCtrl.setStreaming(false);
	...
	public void Initialization(){
		...
		this.setTitle("Asynchonous One Waveform AO - Run(" + configure.deviceName.substring(0, configure.deviceName.length() - 1) + ")");
	...
	class StartButtonActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			try{
				...
				ShowMessage("Sorry,you have not inputed a double number. " + ex.getMessage());
				return;
			}
	 ...
	 * 
	 * @author Administrator
	 * Class Function Description: This class is used to set data in an asynchronous.
	 */
